// Keysight N9021B Configurator Dataset
export const N9021B_DATA = {
  "id": "N9021B",
  "name": "N9021B MXA Signal Analyzer",
  "subtitle": "10 Hz to 50 GHz Premium Performance X-Series Signal Analyzer",
  "family": "Signal Analyzers (MXA-B Series)",
  "docNumber": "5992-1257 / N9021B",
  "description": "The Keysight N9021B MXA is a premium performance X-Series signal analyzer providing up to 510 MHz analysis bandwidth (Option B5X), enhanced low phase noise Option EP1 (-135 dBc/Hz @ 1 GHz, 10 kHz offset), real-time spectrum analysis, DANL extension, and THz external mixing.",
  "baseSpecs": {
  ...
  "steps": [
    {
      ...
      "subtitle": "必选选件（6 选 1），决定 N9021B 的最高测试频率上限",
      ...
      "options": [
        {
          ...
          "freqMaxGHz": 8.4,
          "description": "涵盖 Sub-6GHz 通信频段（C-band、Wi-Fi 6E/7 及 5G FR1 频段）。",
        ...
        },
        {
          ...
          "englishDescription": "Suitable for X-band radar and satellite communications."
        },
        {
          "id": "N9021B-526",
          "code": "N9021B-526",
        ...
        },
        {
          ...
          "freqMaxGHz": 32,
          "description": "扩展频率至 32 GHz，涵盖 Ka 波段与 28 GHz 5G 毫米波应用。",
          "englishDescription": "Extends frequency to 32 GHz for Ka-band and 28 GHz 5G mmWave."
        },
        {
          "id": "N9021B-544",
          "code": "N9021B-544",
    ...
    },
    {
      ...
      "subtitle": "N9021B 增强型相噪 Option EP1 (低至 -135 dBc/Hz @ 1 GHz) 及高精度 OCXO 基准",
      "englishSubtitle": "Enhanced Low Phase Noise (Option EP1) and Precision Frequency Reference (PFR).",
      "type": "multiple",
      "options": [
        {
          "id": "N9021B-PFR",
        ...
        },
        {
          ...
          "englishName": "Enhanced low phase noise performance",
          "category": "Performance",
          "priceEstimate": "+$7,800",
          "description": "在 1 GHz 频率下 10 kHz 偏移相噪低至 -135 dBc/Hz，显著提升调制品质 EVM 与跳频解调精度。",
          "englishDescription": "Delivers enhanced low phase noise (-135 dBc/Hz @ 1 GHz, 10 kHz offset)."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "subtitle": "N9021B 支持高达 510 MHz 的实时解调分析带宽 (Option B5X)，满足 5G NR 及 Wi-Fi 6E/7",
      "englishSubtitle": "N9021B supports up to 510 MHz analysis bandwidth (Option B5X) for 5G NR & Wi-Fi 6E/7.",
      "type": "single",
      "options": [
        {
          "id": "N9021B-B25",
          ...
          "isStandard": true,
          "bandwidthMHz": 25,
          "description": "N9021B 标配 25 MHz 分析带宽。",
        ...
        },
        {
          ...
          "bandwidthMHz": 255,
          "description": "扩展分析带宽至 255 MHz，支持 5G NR 载波聚合与 Wi-Fi 160MHz 解调。",
        ...
        },
        {
          ...
          "bandwidthMHz": 510,
          "description": "N9021B 510 MHz 顶级超宽解调带宽；需选配 MPB/DP4。",
          "englishDescription": "510 MHz real-time analysis bandwidth; requires Option MPB/DP4."
        },
        {
          "id": "N9021B-MPB",
          "code": "N9021B-MPB",
          ...
          "category": "Analysis Bandwidth",
          "priceEstimate": "+$4,800",
          "description": "在 > 3.6 GHz 进行 B2X/B5X 宽带宽测量时必需；开启快速扫描功能 FS1/FS2。",
    ...
    },
    {
      ...
      "englishSubtitle": "Capture memory, fast sweep, external mixing up to 1.1 THz, DANL extension.",
      "type": "multiple",
      "options": [
        {
          "id": "N9021B-DP2",
        ...
        },
        {
          ...
          "category": "Performance",
          "priceEstimate": "+$6,500",
          "description": "4 GB 深度 IQ 捕获内存；选配 B2X/B5X 时随附包含。",
        ...
        },
        {
          ...
          "category": "Performance",
          "priceEstimate": "+$3,500",
          "description": "在全频段开启快速扫描算法；需 MPB。",
    ...
    },
    {
      "id": "step7",
      "stepNumber": 7,
      "title": "增加实时频谱分析 RTSA (Real-Time Spectrum Analysis)",
      "englishTitle": "Add Real-Time Spectrum Analysis",
      "subtitle": "提供 160 MHz / 510 MHz 实时带宽，捕捉瞬态、跳频及同频干扰信号",
      "englishSubtitle": "Real-time spectrum analysis for transient signal capture.",
      "type": "multiple",
      "options": [
        {
          "id": "N9021RT1B",
          "code": "N9021RT1B",
          "name": "实时频谱分析 (基础检测, 最小 17.3us 100% POI)",
          "englishName": "Real-time analysis, Basic Detection",
          "category": "RTSA",
          ...
          "englishDescription": "Real-time analysis with 17.3 us 100% POI signal capture."
        },
        {
          "id": "N9021RT2B",
          "code": "N9021RT2B",
          "name": "实时频谱分析 (最佳检测, 最小 3.5us 100% POI)",
          "englishName": "Real-time analysis, Optimum Detection",
          "category": "RTSA",
          ...
          "englishDescription": "Optimum real-time analysis with 3.5 us 100% POI signal capture."
        },
        {
          "id": "N90EMFT1B",
          "code": "N90EMFT1B",
    ...
    },
    {
      ...
      "subtitle": "增强显示、双通道同步、EMC 预兼容、外部源控制与加速测量",
      "englishSubtitle": "Enhanced display, dual channel, EMI pre-compliance, external source control, and fast power.",
      "type": "multiple",
      "options": [
        {
          "id": "N90EMEDPB",
        ...
        },
        {
          ...
          "category": "Optional Feature",
          "priceEstimate": "+$3,800",
          "description": "大幅缩短 EMC 预兼容扫描测试时间；需搭配 N6141EM0E 及 DP2。",
        ...
        },
        {
          ...
          "category": "Optional Feature",
          "priceEstimate": "+$2,200",
          "description": "大幅提升 ACPR 及通道功率测试速度；需选配 B2X/B5X。",
    ...
    },
    {
      ...
      "subtitle": "第二中频、任意中频、视频输出及 APC-3.5mm 精密接头",
      "englishSubtitle": "Second IF, arbitrary IF, video output, and precision connectors.",
      "type": "multiple",
      "options": [
        {
          "id": "N9021B-CR3",
    ...
    },
    {
      ...
      "options": [
        ...
        },
        {
          "id": "E9055EM0E",
          "code": "E9055EM0E",
          "name": "矢量信号分析高级扩展测量软件 (VMA Advanced)",
          "englishName": "Vector modulation analysis Advanced",
          "category": "Measurement App",
          "priceEstimate": "+$5,800",
          "supportsLicense": true,
          "description": "高级矢量解调特征化分析。",
          "englishDescription": "Advanced vector modulation analysis."
        },
        {
          "id": "E9056EM0E",
          "code": "E9056EM0E",
        ...
        },
        {
          ...
          "englishDescription": "Emulates HP/Agilent spectrum analyzers."
        },
        {
          "id": "E9062EM0E",
          "code": "E9062EM0E",
        ...
        },
        {
          "id": "E9072EM0E",
          "code": "E9072EM0E",
          "name": "cdma2000/1xEV-DO 蜂窝测试软件",
          "englishName": "cdma2000/1xEV-DO",
          "category": "Measurement App",
          "priceEstimate": "+$4,800",
          "supportsLicense": true,
          "description": "cdma2000 蜂窝通信标准解调测量。",
          "englishDescription": "Standard-based cdma2000/1xEV-DO measurements."
        },
        {
          "id": "E9073EM0E",
          "code": "E9073EM0E",
        ...
        },
        {
          ...
          "priceEstimate": "+$4,200",
          "supportsLicense": true,
          "description": "1xEV-DO 信号解调测试。",
          "englishDescription": "Standard-based 1xEV-DO measurement app."
        },
        {
          "id": "E9080EM0E",
          "code": "E9080EM0E",
        ...
        },
        {
          "id": "E9080EM3E",
          "code": "E9080EM3E",
          "name": "NB-IoT & eMTC FDD 物联网测试软件",
          "englishName": "NB-IoT & eMTC FDD",
          "category": "Measurement App",
          "priceEstimate": "+$4,500",
          "supportsLicense": true,
          "description": "窄带物联网 NB-IoT 及 eMTC FDD 信号标准测量。",
          "englishDescription": "Standard-based NB-IoT and eMTC FDD measurement app."
        },
        {
          "id": "E9080EM4E",
          "code": "E9080EM4E",
          "name": "LTE V2X 车联网发射机测试软件",
          "englishName": "LTE V2X",
          "category": "Measurement App",
          "priceEstimate": "+$4,800",
          "supportsLicense": true,
          "description": "LTE V2X 车对车与车对基础设施无线发射机特性测试。",
          "englishDescription": "Standard-based LTE V2X transmitter measurement app."
        },
        {
          "id": "E9082EM0E",
          "code": "E9082EM0E",
        ...
        },
        {
          "id": "E9083EM0E",
          "code": "E9083EM0E",
          "name": "MSR 多标准无线基站测试软件 (Multi-Standard Radio)",
          "englishName": "Multi-standard radio",
          "category": "Measurement App",
          "priceEstimate": "+$6,200",
          "supportsLicense": true,
          "description": "支持 LTE/WCDMA/GSM/cdma2000 多基站信号混合解调。",
          "englishDescription": "Standard-based MSR measurements."
        },
        {
          "id": "E9085EM0E",
          "code": "E9085EM0E",
        ...
        },
        {
          "id": "E9077EM2E",
          "code": "E9077EM2E",
          "name": "WLAN 802.11be (Wi-Fi 7) 320MHz 测量应用软件",
          "englishName": "WLAN 802.11be (Wi-Fi 7)",
          "category": "Measurement App",
          "priceEstimate": "+$7,800",
          "requires": [
            "N9021B-B5X"
          ...
          "supportsLicense": true,
          "description": "支持 Wi-Fi 7 (11be) 320MHz 极宽信道解调与 4096QAM 测试。",
          "englishDescription": "WLAN 802.11be Wi-Fi 7 320MHz measurement app."
        },
        {
          "id": "E9079EM0E",
          "code": "E9079EM0E",
          "name": "TD-SCDMA 蜂窝测试软件",
          "englishName": "TD-SCDMA",
          "category": "Measurement App",
          "priceEstimate": "+$4,500",
          "supportsLicense": true,
          "description": "TD-SCDMA 蜂窝通信解调分析。",
          "englishDescription": "Standard-based TD-SCDMA measurement app."
        },
        {
          "id": "E9081EM0E",
          "code": "E9081EM0E",
        ...
        },
        {
          ...
          "englishName": "Short range comm and IoT",
          "category": "Measurement App",
          "priceEstimate": "+$3,800",
          "supportsLicense": true,
          "description": "LoRa CSS、ZigBee 802.15.4 及 Z-Wave G.9959 物联网信号解调。",
          "englishDescription": "LoRa, 802.15.4 ZigBee, and Z-Wave IoT measurement app."
        }
      ]
    },
    {
      ...
      "subtitle": "矢量解调、5G NR/Wi-Fi 7 (320MHz) 高级故障诊断与 4096QAM 调制分析",
      "englishSubtitle": "Industry-standard vector signal analysis and advanced troubleshooting software.",
      "type": "multiple",
      "options": [
        {
          "id": "89601200C",
      ...
      "options": [
        {
          ...
          "priceEstimate": "+$650",
          "description": "附带 N9021B 工厂全套实测数据报告。",
